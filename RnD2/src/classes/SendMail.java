...
public static void sendMail() {
    ...
    final String subject = "WOL-Web Automation Log File"; //change to your subject
    ...
    props.put("mail.smtp.port", "587");
     ...
     try {
        ...
        String file1 = "D:\\WOL_Mobility\\automation\\RnD2\\Logs\\Logs.log"; //change to your attachment filepath
        String fileName1 = "Logs.log"; //change to your attachment filename
        DataSource source1 = new FileDataSource(file1);
        messageBodyPart.setDataHandler(new DataHandler(source1));
        messageBodyPart.setFileName(fileName1);
        multipart.addBodyPart(messageBodyPart);
        message.setContent(multipart);
        System.out.println("Sending Email Contains Logs File ");
